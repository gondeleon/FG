...
def main() -> int:
    ...
    def preprocess_one(t: float, path: Path) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    ...
    with out.open("w", newline="") as f:
        ...
        t0, p0 = items[0]
        I0raw, I0n, m0, w0 = preprocess_one(t0, p0)
        mask_hist.append(m0)
        ...
        for (t1, p1) in items[1:]:
            I1raw, I1n, m1, w1 = preprocess_one(t1, p1)
            mask_hist.append(m1)
